...
class MeetingAdapter(val c:Context, private val meetingList:ArrayList<MeetingDAO>):RecyclerView.Adapter<MeetingAdapter.MeetingViewHolder>() {
    inner class MeetingViewHolder(private val v:View):RecyclerView.ViewHolder(v){
    ...
    override fun onBindViewHolder(holder: MeetingViewHolder, position: Int) {
        ...
        holder.date.text = newList.meetingDate.toString()
